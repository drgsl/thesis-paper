...
% \addcontentsline{toc}{chapter}{Introduction}
    ...
    \section{Goal}
        \subsection{What makes a piece of software a game engine?}
            ...
            So, in order to satisfy this wikipedia definition, in order for a piece of software \emph{P} to be considered a game engine, \emph{P}has to satisfy the following:
                \begin{itemize}
                    \item \emph{P} must be a software framework
                    \item \emph{P} should include relevant libraries
                    \item \emph{P} should include a suite of engines
                \end{itemize}

            \subsubsection*{is \emph{P} a software framework?}
                ...
                \end{itemize}
        \subsection{What does it mean to be machine learning compatible?}
        ...
        It is unusual for a game company to provide access to its game engine to the end-users. This could be exploited into an competitive disadvantage.
