...
\begin{document}
    ...
    \part{Introduction}
      \section*{Motivation}
          \input{src/content/motivation}
      \section*{Introduction}
          \input{src/content/introduction}
          \input{src/content/bachelors}
          % \begin{center}
          % \includegraphics[width=0.9 \textwidth]{game_engine_overview.png}
          % \end{center}

          \input{src/content/gameEngine/front}
          \pagebreak

          \fancyhead[L]{}
          \fancyhead[C]{Problem Statement}
          \fancyhead[R]{}
          \input{src/content/problem}

          \fancyhead[L]{}
          \fancyhead[C]{Field Study}
          \fancyhead[R]{}

          \input{src/content/study/compGraphHistory}
          \input{src/content/study/phigs.tex}
          \pagebreak


      \section*{Game Engines}
\addcontentsline{toc}{section}{Game Engines}
          \input{src/content/gameEngine/overview}
          \pagebreak
...
\addcontentsline{toc}{section}{Machine Learning Integration}
          \input{src/content/gameEngine/machineLearning}
          \pagebreak

          % \fancyhead[L]{GAME ENGINES}
          % \fancyhead[C]{Solution}
          % \fancyhead[R]{MACHINE LEARNING}
          \input{src/content/solution}
          ...
          % \input{src/content/gameEngine/proof}
          % \input{src/content/proof}


    % \fancyhead[C]{demo}

    \fancyhead[C]{Architectural Design}
    \input{src/content/app/design}
    \part{Implementation}
    \fancyhead[L]{GAME ENGINE} % clear all footer fields
    \fancyhead[R]{IMPLEMENTATION} % clear all footer fields
    \fancyhead[C]{Results}
        \input{src/content/app/demo}
        \input{src/content/app/front}
        \input{src/content/app/inspiration}
        \input{src/content/app/front2}
        \pagebreak
        \input{src/content/app/component}
        \pagebreak
        \fancyhead[C]{}
